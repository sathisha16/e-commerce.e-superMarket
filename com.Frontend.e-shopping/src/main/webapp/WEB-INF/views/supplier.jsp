...
<div class="container" >
  ...
  <li ><a href="productPage">Home</a></li>
				...
				<li class="active"><a href="supplier">SUPPLIER_MANAGEMENT</a></li>
...
<body>
 <form:form method='post' modelAttribute='supplierAttribute' action='addsupplier'>
	 <div class="container">
            ...
            <div class="table-title">
                <div class="row">
					...
					<div >					
							...
							<form:input   id="form101"  path="supplierName" required="true" />
							
					</div>
				
						  <div>  
							<label>SUPPLIER ADDRESS</label>
							<form:input  id="form101"   path="supplierAddress" required="true" />
					 
					</div>
						  <div>
							<label>SUPPLIER EMAIL-ID</label>
							<form:input   id="form101"  path="supplierEmail" required="true" />
					</div> 
						   <div >					
							    <label>SUPPLIER CONTACT NUMBER</label>
							    <form:input  id="form101"  path="supplierPhoneNo" required="true" />
								</div>								
...
<core:forEach items="${supplierlist}" var="supplier">
                    <tr>
                        ...
                        <td>
                           <a href='/com.Frontend.e-shopping/edit/${supplier.supplierid}' class="edit"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                        </td>
                         <td>
                            <a href='/com.Frontend.e-shopping/supplierdelete/${supplier.supplierid}' class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                    </core:forEach>
                 </tbody>
...
<td>
<form:input type='text' path='supplierName' required="true"/>
</td>
</tr>
...
<td>
<form:input type='text' path='supplierAddress' required="true"/>
</td>
</tr>
...
<td>
<form:input type='text' path='supplierPhoneNo' required="true"/>
</td>
</tr>
...
<td>
<form:input type='text' path='supplierEmail' required="true"/>
</td>
</tr>
